...
<table class="table table-hover">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td ><font color="green"><h4><%=correctanswer%>/<%=attemped %></h4></font></td>
    </tr>
  </tbody>
</table>
<center>
<input  onclick="location.href='com.org.Quiz.controller.LogoutStudent'" type="button" value="Exit" class="btn btn-outline-danger btn-lg">
</center>
