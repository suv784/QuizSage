...
<body style="background-color:windowtext;">
<h2><font  face = "WildWest" color="red"><center>Enter Instruction Here</center></font></h2>
<form action="com.org.Quiz.controller.InstructionInsert" method="post">
<pre>

                                                                        Instruction    <input type="text" name="inst" required="Enter instruction">
