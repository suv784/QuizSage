...
<center><h3><pre><font color="red">List of all questions</font></pre></h3></center>
...
<%
  ...
  <td style="color: white;"><%=e.getA()%></td>
  <td style="color: white;"><%=e.getB()%></td>
  <td style="color: white;"><%=e.getC()%></td>
  <td style="color: white;"><%=e.getD()%></td>
  <td style="color: white;"><%=e.getAnswer()%></td>
