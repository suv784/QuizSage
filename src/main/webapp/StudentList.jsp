...
<%@page import="com.org.Quiz.dto.Students"%>
...
<center><h3><pre><font color="red">List of all Students</font></h3></pre></center>
...
<%
  ...
  <td style="color: white;"><%=e.getUsername() %></td>
  <td style="color: white;"><%=e.getName()%></td>
  <td style="color: white;"><%=e.getPassword() %></td>
  <td style="color: white;"><a href="updatestudent.jsp?username=<%=e.getUsername()%>">Update</a></td>
  <td style="color: white;"><a href="deletestudent.jsp?username=<%=e.getUsername()%>">Delete</a></td>
  </tr>
  <%
  }
  %>
